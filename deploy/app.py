...
with tab1:
    ...
    # ⚠️ এখানে তোমার dataset-এর column অনুযায়ী field গুলো বসাতে হবে
    # Example (তোমার dataset-এ এগুলো থাকলে):
    ...
    # Minimal raw row (তোমার churn.csv এর column নামের সাথে মিলিয়ে নিও)
    raw = pd.DataFrame([{
        "Tenure": tenure,
        "Contract": contract,
